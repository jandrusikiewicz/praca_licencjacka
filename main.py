...
def main():
    ...
    get_and_blob(kody_grup_roczne, 5, [2018, 2019, 2020], nazwy_grup_roczne, connection_string, 'con-gus-roczne')
    get_and_blob(kody_grup_kwartalne, 5, [2018, 2019, 2020], nazwy_grup_kwartalne, connection_string,
                 'con-gus-kwartalne')
